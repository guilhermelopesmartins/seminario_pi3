		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Seminario PI3",
									"targetURL": "#seminariopi3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"seminariopi3-display": {
								"semanticObject": "seminariopi3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=seminariopi3",
									"url": sap.ui.require.toUrl("seminariopi3")
								}
							}
						}
					}
